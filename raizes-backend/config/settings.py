...
SECRET_KEY = config('SECRET_KEY', default='dev-secret-key-raizes')
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 20,
    'EXCEPTION_HANDLER': 'apps.core.exceptions.exception_handler_padrao',
}
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API de back-end para rede de lanchonetes com pedidos multicanal, estoque, pagamento mock e fidelidade.',
    'VERSION': '1.0.0',
